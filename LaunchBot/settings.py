"""
Django settings for LaunchBot project.
...
# This line specifies the directory where collectstatic will copy files
...
WSGI_APPLICATION = 'LaunchBot.wsgi.application'
